...
class LevelMainActivity : AppCompatActivity() {

    private lateinit var binding: ActivityLevelMainBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityLevelMainBinding.inflate(layoutInflater)
        ...
        binding.backBtn.setOnClickListener {
            MusicManager.sonClick(context = this@LevelMainActivity)
        ...
        user?.let {
            ...
            currentLevel?.let {max ->
                if (currentLevels == 0){
                    this@LevelMainActivity.currentLevels = it.level
        ...
        binding.recyclerView.apply {
            layoutManager = GridLayoutManager(this@LevelMainActivity, 4)
            adapter = LevelAdaptater(quizList, this@LevelMainActivity, nextAvailableLevel, etoileList, currentLevels) { clickedPosition ->
