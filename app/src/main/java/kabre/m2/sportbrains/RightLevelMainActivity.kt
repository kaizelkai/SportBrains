...
import kabre.m2.sportbrains.databinding.ActivityRightLevelMainBinding

class RightLevelMainActivity : AppCompatActivity() {
    private lateinit var binding: ActivityRightLevelMainBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityRightLevelMainBinding.inflate(layoutInflater)
        ...
        binding.backBtn.setOnClickListener {
            MusicManager.sonClick(context = this@RightLevelMainActivity)
        ...
        binding.leftLevelArrow.setOnClickListener{
            MusicManager.sonClick(context = this@RightLevelMainActivity)
            val intent = Intent(this, LeftLevelMainActivity::class.java)
        ...
        binding.recyclerView.apply {
            layoutManager = GridLayoutManager(this@RightLevelMainActivity, 4)
            adapter = LevelAdaptater(quizList, this@RightLevelMainActivity, nextAvailableLevel, etoileList,currentLevels) { clickedPosition ->
